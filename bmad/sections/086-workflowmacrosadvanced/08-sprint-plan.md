# Section 086: WorkflowMacrosAdvanced — Step 8: Sprint Planning

## Sprint Plan: WorkflowMacrosAdvanced
...
|---|------|------|-------------|
| 1 | Implement WorkflowMacrosAdvanced IIFE with init/destroy | 2h | None |
