# Section 086: WorkflowMacrosAdvanced — Step 6: Architecture

## Architecture: WorkflowMacrosAdvanced

### Module Structure
```
WorkflowMacrosAdvanced (IIFE)
...
### Data Flow
```
Boot → ModuleRegistry.register('WorkflowMacrosAdvanced', { phase: 5, init() { ... } })
