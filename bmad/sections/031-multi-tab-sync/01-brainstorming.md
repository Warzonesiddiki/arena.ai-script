# Section 031: Multi-Tab Sync — Step 1: Brainstorming

## First Principles Analysis

**What is the fundamental purpose of Multi-Tab Sync?**
BroadcastChannel-based cross-tab awareness: pings/pongs to detect other open AAMP tabs.

**What are the atomic primitives?**
1. Module — `MultiTabSync`, an isolated IIFE unit with init/destroy where applicable
