# Section 059: FloatingTOC — Step 9: Story Prep

## Story Prep: FloatingTOC

### Story: Implement FloatingTOC
**As a** system component,  
**I want** fixed left sidebar with heading navigation,  
...
- Registration: ModuleRegistry.register('floatingtoc', { phase: 5, init() { ... } })
