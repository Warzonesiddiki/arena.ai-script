# Section 074: DebuggerConsole — Step 9: Story Prep

## Story Prep: DebuggerConsole

### Story: Implement DebuggerConsole
**As a** system component,  
**I want** in-browser debug console for aamp commands,  
...
- Registration: ModuleRegistry.register('debuggerconsole', { phase: 5, init() { ... } })
