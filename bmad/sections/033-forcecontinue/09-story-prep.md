# Section 033: ForceContinue — Step 9: Story Prep

## Story Prep: ForceContinue

### Story: Implement ForceContinue
**As a** system component,  
**I want** auto-click continue/resume buttons,  
...
- Registration: ModuleRegistry.register('forcecontinue', { phase: 4, init() { ... } })
