# Section 010: Command Palette — Step 1: Brainstorming

## First Principles Analysis

**What is the fundamental purpose of Command Palette?**
...
1. Module — `CommandPalette`, an isolated IIFE unit with init/destroy where applicable
2. Config keys — - `cmdPaletteKey (string, default 'k')`
