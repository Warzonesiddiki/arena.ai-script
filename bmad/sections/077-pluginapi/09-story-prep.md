# Section 077: PluginAPI — Step 9: Story Prep

## Story Prep: PluginAPI

### Story: Implement PluginAPI
**As a** system component,  
**I want** exposes window.aamp api for plugins,  
...
- Registration: ModuleRegistry.register('pluginapi', { phase: 5, init() { ... } })
