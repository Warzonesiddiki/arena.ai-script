# Section 024: Agent Tool Tracker — Step 1: Brainstorming

## First Principles Analysis

**What is the fundamental purpose of Agent Tool Tracker?**
Per-type tool-call counters, driven by the `agent:toolTracked` event.

**What are the atomic primitives?**
1. Module — `AgentToolTracker`, an isolated IIFE unit with init/destroy where applicable
