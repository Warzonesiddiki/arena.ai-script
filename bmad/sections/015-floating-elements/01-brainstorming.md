# Section 015: Floating Elements (TOC + HUD) — Step 1: Brainstorming

## First Principles Analysis

**What is the fundamental purpose of Floating Elements (TOC + HUD)?**
...
1. Module — `FloatingTOC, HUD`, an isolated IIFE unit with init/destroy where applicable
2. Config keys — - `floatingTOC (boolean)`
- `hudPosition (enum)`
