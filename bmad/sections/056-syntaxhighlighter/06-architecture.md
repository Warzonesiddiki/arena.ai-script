# Section 056: SyntaxHighlighter — Step 6: Architecture

## Architecture: SyntaxHighlighter

### Module Structure
```
SyntaxHighlighter (IIFE)
...
### Data Flow
```
Boot → ModuleRegistry.register('SyntaxHighlighter', { phase: 5, init() { ... } })
