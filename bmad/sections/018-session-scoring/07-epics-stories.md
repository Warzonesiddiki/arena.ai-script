# Section 018: Session Scoring — Step 7: Epics & Stories

## Epic: Session Scoring
- **Story 1:** As the boot sequence, I need `PerformanceAnalytics.computeAnalytics` to initialize cleanly so the rest of the
