# Section 057: CollapsibleToolCalls — Step 9: Story Prep

## Story Prep: CollapsibleToolCalls

### Story: Implement CollapsibleToolCalls
**As a** system component,  
**I want** expand/collapse tool call sections,  
...
- Registration: ModuleRegistry.register('collapsibletoolcalls', { phase: 5, init() { ... } })
