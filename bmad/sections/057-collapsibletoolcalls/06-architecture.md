# Section 057: CollapsibleToolCalls — Step 6: Architecture

## Architecture: CollapsibleToolCalls

### Module Structure
```
CollapsibleToolCalls (IIFE)
...
### Data Flow
```
Boot → ModuleRegistry.register('CollapsibleToolCalls', { phase: 5, init() { ... } })
