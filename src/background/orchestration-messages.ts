...
export const ORCHESTRATION_INSIGHTS_MESSAGE = 'aamp:orchestration:insights';
...
export type OrchestrationRequest =
  ...
  | { type: typeof ORCHESTRATION_INSIGHTS_MESSAGE };
...
export function isOrchestrationRequest(message: unknown): message is OrchestrationRequest {
  ...
  if (record.type === ORCHESTRATION_INSIGHTS_MESSAGE) return hasOnlyKeys(record, ['type']);
